"""
============================================================
 PC 串口视频流发送器  (三蜂鸣器真和弦同步版 · 交互式)
============================================================
 功能：将 MP4 视频通过串口实时发送到 STM32 OLED 播放，
       MCU 端首帧到达时自动触发蜂鸣器音乐同步播放。
       搭配 convert_score.py --voices 3 --min-freq 200 生成三声道乐谱。
...
def extract_and_stream(force_port=None):
    ...
    print("        乐谱生成: convert_score.py song.mid --voices 3 --min-freq 200")
